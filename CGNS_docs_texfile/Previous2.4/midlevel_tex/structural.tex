...
\begin{Ventryi}{\fort{basename}}\raggedright
\item [\fort{fn}]
      CGNS file index number.
      (\textcolor{input}{Input})
\item [\fort{B}]
      Base index number, where $1 \leq \text{\fort{B}} \leq \text{\fort{nbases}}$.
      (\textcolor{input}{Input} for \fort{cg\_base\_read};
      \textcolor{output}{\textit{output}} for \fort{cg\_base\_write})
\item [\fort{nbases}]
      Number of bases present in the CGNS file \fort{fn}.
      (\textcolor{output}{\textit{Output}})
\item [\fort{basename}]
      Name of the base.
      (\textcolor{input}{Input} for \fort{cg\_base\_write};
      \textcolor{output}{\textit{output}} for \fort{cg\_base\_read})
\item [\fort{cell\_dim}]
...
\begin{Ventryi}{\fort{zonename}}\raggedright
\item [\fort{fn}]
      CGNS file index number.
      (\textcolor{input}{Input})
\item [\fort{B}]
...
\item [\fort{Z}]
      ...
      (\textcolor{input}{Input} for \fort{cg\_zone\_read},
      \fort{cg\_zone\_type}; \textcolor{output}{\textit{output}} for
      \fort{cg\_zone\_write})
\item [\fort{nzones}]
      Number of zones present in base \fort{B}.
      (\textcolor{output}{\textit{Output}})
\item [\fort{zonename}]
      Name of the zone.
      (\textcolor{input}{Input} for \fort{cg\_zone\_write};
      \textcolor{output}{\textit{output}} for \fort{cg\_zone\_read})
\item [\fort{size}]
...
\item [\fort{zonetype}]
      ...
      (\textcolor{input}{Input} for \fort{cg\_zone\_write};
      \textcolor{output}{\textit{output}} for \fort{cg\_zone\_type})
\item [\fort{ier}]
      Error status.
      (\textcolor{output}{\textit{Output}})
\end{Ventryi}
...
\noindent
\textit{Node}: \fort{SimulationType\_t}
...
\begin{Ventryi}{\fort{SimulationType}}\raggedright
\item [\fort{fn}]
      CGNS file index number.
      (\textcolor{input}{Input})
\item [\fort{B}]
...
\item [\fort{SimulationType}]
      Type of simulation.
      Valid types are \fort{Null}, \fort{UserDefined},
      \fort{TimeAccurate}, and \fort{NonTimeAccurate}.
      (\textcolor{input}{Input} for \fort{cg\_simulation\_type\_write};
      \textcolor{output}{\textit{output}} for \fort{cg\_simulation\_type\_read})
\item [\fort{ier}]
      Error status.
      (\textcolor{output}{\textit{Output}})
\end{Ventryi}
