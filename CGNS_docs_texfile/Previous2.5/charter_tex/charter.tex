%
% Tex input file for CGNS Steering Committee Charter
%
% To generate a DVI file, then a PostScript file named charter.ps:
%
%     latex charter.tex
%     dvips charter.dvi -o
%
% To generate a PDF file named charter.pdf:
%
%     pdflatex charter.tex
...
% }
%  Use just "Appendix.", without the letter "A" 
...
%   \refstepcounter{app}%
%   \addcontentsline{toc}{section}%
%      {\protect\bfseries{\appendixname.\ \ } #1}%
%   {\noindent\Large\bfseries\appendixname.\ \ #2\par}%
%   \sectionmark{#1}\vspace{\baselineskip}}
...
%   \vspace{\baselineskip}}
%  Use just the subappendix name, without the prefix "A.1", etc.
...
%\fancyhead[LE]{\bfseries CGNS Steering Committee Charter}
%\fancyhead[RO]{\bfseries \rightmark}
\fancyhead[LE,RO]{\bfseries CGNS Steering Committee Charter}
\fancyfoot[LE,RO]{\bfseries \thepage}
...
Steering Committee Charter}\\*[0.25in]
{\Large Document Version 1.1.11}}
\author{}
\date{}
\maketitle
\thispagestyle{empty}
...
%Steering Committee Charter\footnote
