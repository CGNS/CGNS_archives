...
\item \fort{GridLocation} is optional; if absent its default value is \fort{Vertex}.
     For 2-D grids (\fort{CellDimension} = 2), \fort{GridLocation} may take
     the additional value of \fort{EdgeCenter}.
     For 3-D grids (\fort{CellDimension} = 3), \fort{GridLocation} may take
     the additional values of \fort{EdgeCenter}, \fort{FaceCenter},
...
used to list the vertices or cell faces making up the BC patch.  When
...
\begin{tabular}{||c|c|c|c||}
 \hline
\texttt{CellDimension} & \multicolumn{3}{c||}{\texttt{GridLocation}} \\
& \texttt{Vertex} & \texttt{EdgeCenter} & \texttt{*FaceCenter} \\
 \hline
1 & vertices & $-$ & $-$ \\
2 & vertices & edges & $-$ \\
