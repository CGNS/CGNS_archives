...
This example uses Cartesian coordinates for a 2-D grid of size $17\times33$; the data
...
Because the dimensional units for both $x$ and $y$ are the same, an
...
For example, for \texttt{NGON\_n}, the data array \texttt{ElementConnectivity}
...
\texttt{CellDimension} and \texttt{GridLocation}.  \autoref{t:gridlocationusage1} shows
these relations.

\begin{table}[htbp]
\centering
\caption[GridLocation Usage]{\textbf{GridLocation Usage}}
\label{t:gridlocationusage1}
...
permissible in \texttt{PointRange/List}. \autoref{t:gridlocationusage2} shows these relations.

\begin{table}[htbp]
\centering
\caption[GridLocation Usage with Zone Subregions]{\textbf{GridLocation Usage with Zone Subregions}}
\label{t:gridlocationusage2}
