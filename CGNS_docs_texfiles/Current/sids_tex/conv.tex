...
The quartic form of the line, \fort{BAR\_5}, contains three nodes
interior to the endpoints.
...
Six types of triangular elements are supported in CGNS, \fort{TRI\_3},
\fort{TRI\_6}, \fort{TRI\_9}, \fort{TRI\_10}, \fort{TRI\_12}, and \fort{TRI\_15}.
...
The quartic forms of triangular elements, \fort{TRI\_12} and \fort{TRI\_15}
contain three interior nodes along each edge, and three interior face nodes
in the case of \fort{TRI\_15}.
...
CGNS supports seven types of quadrilateral elements, \fort{QUAD\_4},
\fort{QUAD\_8}, \fort{QUAD\_9}, \fort{QUAD\_12}, \fort{QUAD\_16}, \fort{QUAD\_P4\_16}, and \fort{QUAD\_25}.
...
The quartic forms of quadrilateral elements, \fort{QUAD\_P4\_16} and \fort{QUAD\_25}
contain three interior nodes along each edge, and nine interior face nodes
in the case of \fort{QUAD\_25}.
...
CGNS supports seven types of tetrahedral elements, \fort{TETRA\_4},
\fort{TETRA\_10}, \fort{TETRA\_16}, \fort{TETRA\_20}, \fort{TETRA\_22}, \fort{TETRA\_34}, and \fort{TETRA\_35}.
...
The quartic forms of tetrahedral elements, \fort{TETRA\_22}, \fort{TETRA\_34}, and \fort{TETRA\_35}
contain three interior nodes along each edge, twelve interior face nodes
in the case of \fort{TETRA\_34}, and twelve interior face nodes plus one interior volume
node in the case of \fort{TETRA\_35}.
...
\begin{Ventryi}{\fort{N1,\ldots,N27}}
   \item [\fort{N23}]
         Is located at the centroid of sub-triangle \fort{N1-N12-N6}.
   \item [\fort{N24}]
         Is located at the centroid of sub-triangle \fort{N2-N6-N9}.
   \item [\fort{N25}]
         Is located at the centroid of sub-triangle \fort{N3-N9-N12}.
   \item [\fort{N26}]
         Is located at the centroid of sub-triangle \fort{N1-N6-N15}.
   \item [\fort{N27}]
         Is located at the centroid of sub-triangle \fort{N2-N18-N6}.
   \item [\fort{N28}]
         Is located at the centroid of sub-triangle \fort{N4-N15-N18}.
   \item [\fort{N29}]
         Is located at the centroid of sub-triangle \fort{N2-N9-N18}.
   \item [\fort{N30}]
         Is located at the centroid of sub-triangle \fort{N3-N21-N9}.
   \item [\fort{N31}]
         Is located at the centroid of sub-triangle \fort{N4-N18-N21}.
   \item [\fort{N32}]
         Is located at the centroid of sub-triangle \fort{N3-N12-N21}.
   \item [\fort{N33}]
         Is located at the centroid of sub-triangle \fort{N1-N15-N12}.
   \item [\fort{N34}]
         Is located at the centroid of sub-triangle \fort{N4-N21-N15}.
   \item [\fort{N35}]
         Is located at the centroid of the tetrahedron.
\end{Ventryi}

\paragraph{Pyramid Elements}
CGNS supports nine types of pyramid elements, \fort{PYRA\_5},
...
\begin{Ventryi}{\fort{N1,\ldots,N27}}
   \item [\fort{N39}]
         Is located at the centroid of sub-triangle \fort{N1-N7-N19}.
   \item [\fort{N40}]
         Is located at the centroid of sub-triangle \fort{N2-N22-N7}.
   \item [\fort{N41}]
         Is located at the centroid of sub-triangle \fort{N5-N19-N22}.
   \item [\fort{N42}]
         Is located at the centroid of sub-triangle \fort{N2-N10-N22}.
   \item [\fort{N43}]
         Is located at the centroid of sub-triangle \fort{N3-N25-N10}.
   \item [\fort{N44}]
         Is located at the centroid of sub-triangle \fort{N5-N22-N25}.
   \item [\fort{N45}]
         Is located at the centroid of sub-triangle \fort{N3-N13-N25}.
   \item [\fort{N46}]
         Is located at the centroid of sub-triangle \fort{N4-N28-N13}.
   \item [\fort{N47}]
         Is located at the centroid of sub-triangle \fort{N5-N25-N28}.
   \item [\fort{N48}]
         Is located at the centroid of sub-triangle \fort{N4-N16-N28}.
   \item [\fort{N49}]
         Is located at the centroid of sub-triangle \fort{N1-N19-N16}.
   \item [\fort{N50}]
         Is located at the centroid of sub-triangle \fort{N5-N28-N19}.
   \item [\fort{N51}]
         Is located at the intersection of the line \fort{N5-N30} and the face \fort{N18-N21-N24-N27}.
   \item [\fort{N52}]
         Is located at the intersection of the line \fort{N5-N32} and the face \fort{N18-N21-N24-N27}.
   \item [\fort{N53}]
         Is located at the intersection of the line \fort{N5-N34} and the face \fort{N18-N21-N24-N27}.
   \item [\fort{N54}]
         Is located at the intersection of the line \fort{N5-N36} and the face \fort{N18-N21-N24-N27}.
   \item [\fort{N55}]
         Is located at the intersection of the line \fort{N5-N38} and the face \fort{N20-N23-N26-N29}.
\end{Ventryi}

\paragraph{Pentahedral Elements}
CGNS supports nine types of pentahedral elements, \fort{PENTA\_6},
\fort{PENTA\_15}, \fort{PENTA\_18}, \fort{PENTA\_24}, \fort{PENTA\_38}, \fort{PENTA\_40},
\fort{PENTA\_33}, \fort{PENTA\_66}, and \fort{PENTA\_75}.
...
in the case of \fort{PENTA\_66}, and 33 interior face nodes and an additonal
nine interior volume nodes for \fort{PENTA\_75}.
...
\begin{Ventryi}{\fort{N1,\ldots,N27}}
   ...
   \item [\fort{F1,\ldots,F5}]
         ...
         third node, is oriented outward.
   \item [\fort{N39}]
         Is at the centroid of the triangle \fort{N13,N17,N15}.
   \item [\fort{N40}]
         Is at the centroid of the triangle \fort{N14,N18,N16}.
\end{Ventryi}
...
\begin{Ventryi}{\fort{N1,\ldots,N27}}
   \item [\fort{N34}]
         Is located at the centroid of sub-triangle \fort{N1-N14-N8}.
   \item [\fort{N35}]
         Is located at the centroid of sub-triangle \fort{N2-N8-N11}.
   \item [\fort{N36}]
         Is located at the centroid of sub-triangle \fort{N3-N11-N14}.
   \item [\fort{N64}]
         Is located at the centroid of sub-triangle \fort{N4-N26-N32}.
   \item [\fort{N65}]
         Is located at the centroid of sub-triangle \fort{N5-N29-N26}.
   \item [\fort{N66}]
         Is located at the centroid of sub-triangle \fort{N6-N32-N29}.
   \item [\fort{N67}]
         Is located at the centroid of sub-triangle \fort{N16-N38-N56}.
   \item [\fort{N68}]
         Is located at the centroid of sub-triangle \fort{N19-N47-N38}.
   \item [\fort{N69}]
         Is located at the centroid of sub-triangle \fort{N22-N56-N47}.
   \item [\fort{N70}]
         Is located at the centroid of sub-triangle \fort{N17-N45-N63}.
   \item [\fort{N71}]
         Is located at the centroid of sub-triangle \fort{N20-N54-N45}.
   \item [\fort{N72}]
         Is located at the centroid of sub-triangle \fort{N23-N63-N54}.
   \item [\fort{N73}]
         Is located at the centroid of sub-triangle \fort{N18-N42-N60}.
   \item [\fort{N74}]
         Is located at the centroid of sub-triangle \fort{N21-N51-N42}.
   \item [\fort{N75}]
         Is located at the centroid of sub-triangle \fort{N24-N60-N51}.
\end{Ventryi}

\paragraph{Hexahedral Elements}
CGNS supports nine types of hexahedral elements, \fort{HEXA\_8},
\fort{HEXA\_20}, \fort{HEXA\_27}, \fort{HEXA\_32}, \fort{HEXA\_56}, \fort{HEXA\_64},
\fort{HEXA\_44}, \fort{HEXA\_98}, and \fort{HEXA\_125}.
...
in the case of \fort{HEXA\_98}, and 54 interior face nodes and an additonal
27 interior volume nodes for \fort{HEXA\_125}.
