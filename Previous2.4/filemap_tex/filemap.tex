%
% Tex input file for CGNS SIDS-to-ADF File Mapping Manual
%
...
\usepackage{hyperref}			% for hypertext links in PDF
   \hypersetup{letterpaper,plainpages=false,
               pdftitle={CGNS SIDS-to-ADF File Mapping Manual},
...
%\fancyhead[LE]{\bfseries SIDS-to-ADF File Mapping Manual}
...
SIDS-to-ADF File Mapping Manual}\\*[0.25in]
{\Large Document Version 2.4.2\\
CGNS Version 2.4.4}}
\author{}
\date{}
\maketitle
...
%SIDS-to-ADF File Mapping Manual\footnote
